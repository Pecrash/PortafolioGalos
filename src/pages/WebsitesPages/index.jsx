	...
	return (
		<div className="websitesPage">
			...
			<div className="websitesPage__website">
				<img className="websitesPage__website-img" src="/src/assets/Images/websites/peluqueria.png" alt="" />
			...
			<div className="websitesPage__website">
				<img className="websitesPage__website-img" src="/src/assets/Images/websites/odontologia.png" alt="" />
			...
			<div className="websitesPage__website">
				<img className="websitesPage__website-img" src="/src/assets/Images/websites/servicentro.png" alt="" />
